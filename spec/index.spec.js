...
describe('/api', () => {
  ...
  describe('Errors', () => {
    it('error 404 on non existent route on / ', () => request
      .get('/bad-route')
      .expect(404)
      .then((response) => {
  ...
  describe('/topics', () => {
    ...
    it('error 404 on non existent route on /api/topics/ ', () => request
      .get('/api/topics/bad-route')
      .expect(404)
      .then((response) => {
        expect(response.body.msg).to.equal('Route not Found');
      }));
    it('GET topics with status 200 and keys slug and description', () => request
      .get('/api/topics')
      .expect(200)
      .then((res) => {
  ...
  describe('/articles', () => {
    it('error 404 on non existent route on /users ', () => request
    ...
    describe('GET /articles', () => {
      it('GET articles with keys author, title article_id, topic, created_at, vote comment_count', () => request
        .get('/api/articles')
        .expect(200)
        .then((res) => {
      ...
      it('GET comment_count to be equal amount of comments from each article', () => request
        .get('/api/articles')
        .expect(200)
        .then((res) => {
    ...
    describe('/:article_id', () => {
      it('will ignore an invalid sort_by query', () => request
      ...
      describe('GET /article/query ', () => {
        it('GET articles filtered by author', () => request
          .get('/api/articles?author=butter_bridge')
          .expect(200)
          .then((res) => {
            expect(res.body.articles).to.have.lengthOf(3);
          }));
        it('GET articles filtered by topic', () => request
          .get('/api/articles?topic=mitch')
          .expect(200)
          .then((res) => {
            expect(res.body.articles).to.have.lengthOf(11);
          }));
        it('GET articles filtered by author and topic', () => request
          .get('/api/articles?author=butter_bridge&topic=mitch')
          .expect(200)
          .then((res) => {
            expect(res.body.articles).to.have.lengthOf(3);
          }));
        it('GET articles sorted by author in ascending order ', () => request
  ...
  describe(' /api/articles/:article_id', () => {
    describe('GET /article', () => {
      it('GET it should return an article by given id', () => request
        .get('/api/articles/1')
        .expect(200)
        .then((res) => {
    ...
    describe('PATCH /article', () => {
      ...
      it('DELETE it should give status code 400 when invalid id provided', () => request.delete('/api/articles/ww').expect(400));
      it('DELETE it should give status code 404 when non existent id', () => request.delete('/api/articles/99').expect(404));

      it('DELETE it should delete an article by given id and send status code 204', () => request.delete('/api/articles/4').expect(204));
    });
  });
  ...
  describe('/comments', () => {
    ...
    describe('GET /api/articles/:article_id/comments', () => {
      it('GET should return all the comments belonging to given article', () => request
      ...
      it('GET it should accept query sort_by and order set to desc or asc', () => request
    ...
    describe('PATCH /:comment_id', () => {
      ...
      it('DELETE it should delete comment by its id', () => request
  ...
  describe('/users', () => {
    it('POST wrong request returns an error with status 400', () => request
      .post('/api/users/')
      .send({
        name: 'tom',
        avatar_url:
    ...
    it('error 405 method patch not allowed', () => request
      .patch('/api/users')
      .expect(405)
      .then((response) => {
        expect(response.body.msg).to.equal('method not allowed');
      }));
    it('error 405 method delete not allowed', () => request
      .delete('/api/users')
      .expect(405)
      .then((response) => {
        expect(response.body.msg).to.equal('method not allowed');
    ...
    describe('GET/ /api/users', () => {
      it('GET it should return all users from database', () => request
        .get('/api/users')
        .expect(200)
        .then((res) => {
