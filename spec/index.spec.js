...
describe('/api', () => {
  ...
  describe('/articles', () => {
    describe('GET /articles', () => {
      ...
      it('GET comment_count to be equal amount of coments from each article', () => request
        .get('/api/articles')
        .expect(200)
        .then((res) => {
  ...
  describe(' /api/articles/:article_id', () => {
    describe('GET /article', () => {
      it('GST it should return an article by given id', () => request
        .get('/api/articles/1')
        .expect(200)
        .then((res) => {
    ...
    describe('PATCH /article', () => {
      ...
      it('DELETE it should delete an article by given id and send status code 204', () => request.delete('/api/articles/1').expect(204));
    });
  });
